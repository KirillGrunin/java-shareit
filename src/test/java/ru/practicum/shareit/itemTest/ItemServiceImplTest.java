...
public class ItemServiceImplTest {
    ...
    @Test
    void searchItems() {
        when(itemRepository.findAllByNameContainingIgnoreCaseOrDescriptionContainingIgnoreCaseAndAvailabilityIsTrue(
        ...
        verify(itemRepository, times(1))
                .findAllByNameContainingIgnoreCaseOrDescriptionContainingIgnoreCaseAndAvailabilityIsTrue(anyString(), anyString(), any());
    }
